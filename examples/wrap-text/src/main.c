...
void main(void) {
    ...
    char text[] = {"\tThis line starts with a tab.\n\nA demonstration of multiple newline breaks.\n\n\tQuick question: When did indenting paragraphs become a common standard? Did it start with Gutenburg or did someone else invent it in the following centuries after the printing press's invention?\n\t\tDouble tabbing can also help set your text away from the left margin. Tabs in your text while printing centered, however, makes it look off-center."};
